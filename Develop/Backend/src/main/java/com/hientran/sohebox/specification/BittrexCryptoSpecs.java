...
public class BittrexCryptoSpecs extends GenericSpecs {
    ...
    public Specification<BittrexCryptoTbl> buildSpecification(BittrexCryptoSCO sco) {
        ...
        if (sco != null) {
            ...
            specification = specification.and(buildSearchBoolean(BittrexCryptoTblEnum.restricted.name(), sco.getRestricted()));
            ...
            specification = specification.and(buildSearchText(BittrexCryptoTblEnum.currencyLong.name(), sco.getCurrencyLong()));
            specification = specification.and(buildSearchNumber(BittrexCryptoTblEnum.minConfirmation.name(), sco.getMinConfirmation()));
            ...
            specification = specification.and(buildSearchText(BittrexCryptoTblEnum.baseAddress.name(), sco.getBaseAddress()));
            specification = specification.and(buildSearchBoolean(BittrexCryptoTblEnum.deleteFlag.name(), sco.getDeleteFlag()));
        }
